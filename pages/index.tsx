		...
		<Layout>
			<main className="overflow-x-hidden">
				<div className="relative h-screen w-auto overflow-hidden">
					<div className="absolute top-0 left-0 w-full lg:h-16 h-28 bg-gradient-to-t from-transparent to-black opacity-70"></div>
					...
					<div className="font-text justify-center flex items-center w-full h-52 overflow-hidden pt-16 lg:pt-20 sm:pt-12 lg:pb-10">
						<section className="inline-flex width-screen">
							...
							>
								{text1.map((text, index) => (
									<motion.span
										...
										className="text-4xl lg:text-5xl text-black z-10 ml-2 mt-3 lg:ml-4 lg:mt-5"
									>
										{text}
									</motion.span>
								))}
								{text2.map((texted, index) => (
									<motion.span
										...
										key={index}
										animate={inView ? "visible" : "hidden"}
										className="text-4xl lg:text-5xl mt-3 lg:mt-5 overflow-visible"
									>
										{texted}
									</motion.span>
								))}
							...
							<motion.div
								...
								className="w-16 h-16 bg-zinc-300 absolute rounded-md lg:w-[5.5rem] lg:h-[5.5rem]"
							></motion.div>
						</section>
					</div>
